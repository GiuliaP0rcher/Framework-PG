...
void SceneManager::initializeGraphics()
{
	...
	addShader("../shaders/Colorização.vs", "../shaders/Colorização.frag");
	addShader("../shaders/Inversao.vs", "../shaders/Inversao.frag");
	addShader("../shaders/Binarizacao.vs", "../shaders/Binarizacao.frag");
	addShader("../shaders/Vignette.vs", "../shaders/Vignette.frag");
...
void SceneManager::render()
{
	...
	for (int i = 0; i < objects.size(); i++)
	{
		...
		if (i == 5)
		{
			...
			glUniform1i(glGetUniformLocation(shaders[5]->ID, "ourTexture2"), 1);
...
void SceneManager::setupScene()
{
	...
	shaders[2]->setVec3("Colorizadora", 1.0, 0.0, 1.0);
	...
	obj = new Sprite;
	obj->setPosition(glm::vec3(200.0f, 500.0f, 0.0));
	obj->setDimension(glm::vec3(200.0f, 200.0f, 1.0f)); //note que depois podemos reescalar conforme tamanho da sprite
	...
	obj = new Sprite;
	obj->setPosition(glm::vec3(600.0f, 500.0f, 0.0));
	obj->setDimension(glm::vec3(200.0f, 200.0f, 1.0f));
